    ...
    <main className="min-h-screen bg-[#fdfcfb] text-[#172039]">
      <section className="relative overflow-hidden border-b border-[#e2ded8]">
        ...
        <svg aria-hidden="true" className="pointer-events-none absolute inset-0 h-full w-full" viewBox="0 0 1200 620" preserveAspectRatio="none" fill="none">
          ...
          <path d="M-40 170 C180 130 330 190 520 112 C730 25 940 120 1240 25" stroke="#c89b55" strokeWidth="1.35" opacity=".38" strokeDasharray="1800" strokeDashoffset="1800"><animate attributeName="stroke-dashoffset" from="1800" to="0" dur="1.7s" fill="freeze" /></path>
          <path d="M-30 300 C180 340 330 250 500 285 C700 330 880 245 1230 150" stroke="#d0a565" strokeWidth="1" opacity=".24" strokeDasharray="1800" strokeDashoffset="1800"><animate attributeName="stroke-dashoffset" from="1800" to="0" begin=".16s" dur="1.8s" fill="freeze" /></path>
          <path d="M-20 470 C210 540 300 420 520 430 C760 442 920 560 1235 365" stroke="#d8b67a" strokeWidth=".8" opacity=".42" strokeDasharray="1800" strokeDashoffset="1800"><animate attributeName="stroke-dashoffset" from="1800" to="0" begin=".3s" dur="1.9s" fill="freeze" /></path>
          ...
          <circle cx="430" cy="150" r="5.5" fill="#c89b55" filter="url(#gold-glow)" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="1.85s" dur=".45s" fill="freeze" /></circle>
          <circle cx="930" cy="230" r="5" fill="#d0a565" filter="url(#gold-glow)" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="2s" dur=".45s" fill="freeze" /></circle>
          <circle cx="320" cy="475" r="4.5" fill="#d8b67a" filter="url(#gold-glow)" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="2.1s" dur=".45s" fill="freeze" /></circle>
        </svg>
      </section>
