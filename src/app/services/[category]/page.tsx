    ...
    <main className="min-h-screen bg-[#fdfcfb] text-[#172039]">
      <section className="relative overflow-hidden border-b border-[#e2ded8]">
        ...
        <svg aria-hidden="true" className="pointer-events-none absolute inset-0 h-full w-full" viewBox="0 0 1200 620" preserveAspectRatio="none" fill="none">
          ...
          <circle r="5.5" fill="#c89b55" filter="url(#gold-glow)" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="1.85s" dur=".45s" fill="freeze" /><animateMotion dur="13s" begin="2.3s" repeatCount="indefinite"><mpath href="#hero-main-line-1" /></animateMotion></circle>
          <circle r="5" fill="#d0a565" filter="url(#gold-glow)" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="2s" dur=".45s" fill="freeze" /><animateMotion dur="16s" begin="2.45s" repeatCount="indefinite" keyPoints="1;0" keyTimes="0;1" calcMode="linear"><mpath href="#hero-main-line-2" /></animateMotion></circle>
          <circle r="4.5" fill="#d8b67a" filter="url(#gold-glow)" opacity="0"><animate attributeName="opacity" from="0" to="1" begin="2.1s" dur=".45s" fill="freeze" /><animateMotion dur="18s" begin="2.55s" repeatCount="indefinite"><mpath href="#hero-main-line-3" /></animateMotion></circle>
        </svg>
      </section>
