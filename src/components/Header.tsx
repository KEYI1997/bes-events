...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    href: '/events',
    children: [
      { label: '開幕典禮', href: '/events/grand-opening' },
      { label: '記者會', href: '/events/press-conference' },
      { label: '新品發表會', href: '/events/product-launch' },
      { label: '展覽攤位', href: '/events/exhibition' },
      { label: '政府活動', href: '/events/government' },
      { label: '春酒尾牙', href: '/events/banquet' },
      { label: '典禮節慶', href: '/events/ceremony' },
    ],
  },
        ...
        <div className="relative h-full overflow-y-auto pt-24 pb-12 px-6 md:px-12 lg:px-20">
          ...
          <div className="max-w-6xl mx-auto mt-16 pt-8 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row gap-6 text-sm text-primary/70">
              ...
              <a href="https://line.me/ti/p/~@648ubibg" target="_blank" rel="noopener noreferrer" className="hover:text-cta transition-colors">💬 LINE：@648ubibg</a>
            </div>
          </div>
        </div>
      </div>
