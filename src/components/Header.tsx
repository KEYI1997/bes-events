...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    href: '/cases',
    children: [
      { label: '開幕典禮', href: '/cases?category=開幕典禮' },
      { label: '記者會', href: '/cases?category=記者會' },
      { label: '新品發表會', href: '/cases?category=新品發表會' },
      { label: '展覽攤位', href: '/cases?category=展覽攤位' },
      { label: '政府活動', href: '/cases?category=政府活動' },
      { label: '春酒尾牙', href: '/cases?category=春酒尾牙' },
      { label: '典禮節慶', href: '/cases?category=典禮節慶' },
    ],
  },
